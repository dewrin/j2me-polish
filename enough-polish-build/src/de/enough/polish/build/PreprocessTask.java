...
import de.enough.polish.build.util.*;
 ...
 */
public class PreprocessTask extends MatchingTask {
	...
	public void init() throws BuildException {
		...
		this.condition = new Condition( getProject() );
	...
	/**
	 * Provides fine-grained control over task execution based on a property definition. 
	 * The task will only be executed if the given property is defined.
	 * 
	 * @param s the property which needs to be defined.
	 */
	...
	/**
	 * Provides fine-grained control over task execution based on a property definition. 
	 * The task will only be executed if the given property is not defined.
	 *  
	 * @param s the property which must not be defined.
	 */
